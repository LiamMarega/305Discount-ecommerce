    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <h2 className="text-[17px] font-extrabold tracking-tight">{t('title')}</h2>
                {hasActiveFilters && (
            ...
            {Object.entries(facetGroups).map(([facetName, facet]) => (
                <Collapsible key={facet.id} defaultOpen>
                    <div className="space-y-2">
                        <CollapsibleTrigger className="flex w-full items-center justify-between py-2 text-[13px] font-bold uppercase tracking-[0.08em] text-brand-ink transition-colors hover:text-brand-blue">
                            {facetName}
