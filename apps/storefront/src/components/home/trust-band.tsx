...
const stats = [
    {n: '3', l: 'Home categories'},
    {n: 'Miami', l: 'Local inventory'},
    {n: 'Direct', l: 'Store support'},
    {n: 'Fresh', l: 'Discount deals'},
];

export function TrustBand() {
    return (
        <section className="relative overflow-hidden text-white [background:linear-gradient(135deg,var(--brand-navy),#023675_55%,var(--brand-blue-deep))]">
            <div className="eh-wrap relative z-[2] py-12 text-center md:py-16">
                <Reveal as="p" className="mb-[18px] inline-flex items-center gap-3 text-[12.5px] font-bold uppercase tracking-[0.22em] text-brand-gold-lite">
                    <Star className="size-[15px] fill-current" /> 305 Discount · Miami, FL
                </Reveal>
                <Reveal as="h2" delay={80} className="mx-auto max-w-[24ch] text-balance text-[clamp(24px,3.2vw,36px)] font-extrabold leading-[1.1] tracking-tight">
                    Home essentials,<br />priced to move.
                </Reveal>
                <Reveal as="p" delay={160} className="mx-auto mt-5 max-w-[56ch] text-[clamp(15px,1.5vw,18px)] text-white/[0.74]">
                    Furniture, appliances and mattresses in one catalog, with current Miami inventory and a team you can contact directly before you buy.
                </Reveal>
                <Reveal as="div" delay={160} className="mt-8">
                    ...
                    >
                        Chat with 305 Discount <ArrowRight className="size-[18px]" />
                    </a>
                </Reveal>
