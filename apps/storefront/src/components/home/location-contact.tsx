...
const contactCards = [
    {icon: MapPin, label: 'Address', value: BRAND.addressLine, href: BRAND.mapsDirections, external: true},
    {icon: Phone, label: 'Phone', value: `+1 ${BRAND.phoneDisplay}`, href: BRAND.phoneHref},
    {icon: Mail, label: 'Email', value: BRAND.email, href: BRAND.emailHref},
    {icon: WhatsAppIcon, label: 'WhatsApp', value: `+1 ${BRAND.phoneDisplay}`, href: BRAND.whatsappHref, external: true},
];
                ...
                <div className="grid items-stretch gap-8 lg:grid-cols-2 lg:gap-10">
                    <Reveal as="div" className="flex flex-col">
                        <p className="max-w-[56ch] text-[clamp(15px,1.4vw,17px)] text-brand-muted">
                            Come see the appliances in person, talk financing with our team, and walk out with a plan
                            that works for you.
                        </p>
                        <div className="relative mt-6 aspect-[16/10] overflow-hidden rounded-[20px] shadow-brand">
                            <Image
                                src="/brand/store/interior.jpg"
                                alt="Refrigerators and appliances on display inside the Easy Home Appliances store"
                                fill
                    ...
                    <Reveal as="div" delay={80} className="relative min-h-[440px] overflow-hidden rounded-[28px] bg-[#e7ebf1] shadow-brand">
                        ...
                        <div className="absolute bottom-[18px] left-[18px] z-[3] max-w-[78%] rounded-[14px] bg-white px-[18px] py-3.5 shadow-brand-lg">
                            ...
                            <div className="mt-0.5 text-[13px] text-brand-muted">{BRAND.addressLine}</div>
                        </div>
                        <a
